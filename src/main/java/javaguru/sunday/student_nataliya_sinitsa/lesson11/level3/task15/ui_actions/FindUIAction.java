...
public class FindUIAction implements UIAction {
    ...
    public FindUIAction(BookDatabaseV2 bookDatabase) {
        this.bookDatabase = bookDatabase;
    }

    public void execute() {
        //по соотношению "польза-риск" выполнение данного пункта
        //задания 38 отложено из-за высокого риска потери времени :)
    }
